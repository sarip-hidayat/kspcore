...
<head>
   ...
   <script src="../assets/scripts/form-validationtabungan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/tool/cronjob.js"></script>
                        ...
                        <div class="span12">
                            <div class="tabbable tabbable-custom boxless">
                                <ul class="nav nav-tabs">
                                   <li class="active"><a href="#tabs-1" data-toggle="tab">Data Otomasisasi</a></li>
                                </ul>
                                            ...
                                            <table class="table table-hover">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Zakat</td>
                                                        <td></td>
                                                         <td align="right"><button class="btn btn-warning" id="aZakat"><i class="icon-ok"></i> Proses</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Administrasi</td>
                                                        <td></td>
                                                         <td align="right"><button class="btn btn-warning" id="aAdm"><i class="icon-ok"></i> Proses</button></td>
                                                    </tr>
                                                    <tr>
                                                        <td>PPH</td>
                                                        <td></td>
                                                         <td align="right"><button class="btn btn-warning" id="aPph"><i class="icon-ok"></i> Proses</button></td>
                                                    </tr>
