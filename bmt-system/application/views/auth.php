...
<head>
  <meta charset="utf-8" />
  <title>KOPERASI ANNUR BERKAH MANDIRI - Login</title>
  ...
  <script type="text/javascript" src="<?php echo base_url()?>assets/js/jq/jquery-1.3.2.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url()?>assets/js/jq/jquery-ui-1.7.2.custom.min.js"></script>
  <?php $this->load->view( 'header' );?>
  <script type="text/javascript" src="<?php echo base_url()?>assets/js/auth.js"></script>
</head>
<body>
    <div id="logo" class="center">
        <img src="assets/img/logo2.png" alt="BMT" class="center" />
    </div>
  <div id="login">
  <p class="center"></p>
    <form>
