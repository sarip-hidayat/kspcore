                        ...
                        <div class="span12">
                            <div class="tabbable tabbable-custom boxless">
                                <ul class="nav nav-tabs">
                                   <li class="active"><a href="#tabs-1" data-toggle="tab">Transaksi Lain</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tabs-1">
                                        <form class="form-horizontal" id="form_selisihkurang" method="post">
                                        <div class="span12">
                                            ...
                                            <div class="control-group fm-req">
                                                ...
                                                <div class="controls">
                                                    <select class="inp input-small" name="accounttrans_code">
                                                        <option value="02">Uang Keluar</option>
                                                        <option value="01">Uang Masuk</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="control-group fm-req">
                                                <label class="control-label">Nama Account <span class="required">*</span></label>
                                                <div class="controls">
                                                    <select class="inp input-xlarge" name="accounttrans_type" id="jurnal1"></select>
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="control-group fm-req">
