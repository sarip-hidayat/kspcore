                        ...
                        <div class="span12">
                            <div class="tabbable tabbable-custom boxless">
                                <ul class="nav nav-tabs">
                                   <li class="active"><a href="#tabs-1" data-toggle="tab">Laporan Teller</a></li>
                                </ul>
                                    ...
                                    <div class="tab-pane active" id="tabs-1">
                                        ...
                                        <div class="span12" id="table_lapteller">
                                            ...
                                            <div class="control-group fm-req">
                                                ...
                                                <button class="btn btn-primary" id="showlap"><i class="icon-search"></i> Search</button> <span class="infoproses"><img src="assets/images/loading.gif"> Proses...</span>
                                                </div>
                                            </div>
                                            <div style="width:100%;background:#fff">
                                                <div id="tlaptransteller">
                                                    <table style="margin-left:5px;width:99%;color:#000">
                                                        <thead>
                                                        <tr>
                                                            <td colspan="7" style="text-align:left;"><b>Laporan Teller [{{ idpeg }}]</b></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr class="jdl" style="text-align:center;background:#EFF1F1">
                                                            <td width="10%" style="border-top:1px solid #000"><b>No. Ref</b></td>
                                                            <td width="10%" style="border-top:1px solid #000"><b>No. Rekening</b></td>
                                                            ...
                                                            <td width="10%" style="border-top:1px solid #000"><b>Saldo Akhir</b></td>
                                                        </tr>
                                                        </thead>
                                                        <tbody></tbody>
                                                    </table>
...
{% block footer %}
    ...
    {% block footer_dialog %}
        <iframe name="ctkframe" id="ctkframe" style="width:0px;height:0px;border:0" src="trans/reportteller/cetakLapTeller"></iframe>
