                        ...
                        <div class="span12">
                            <div class="tabbable tabbable-custom boxless">
                                <ul class="nav nav-tabs">
                                   <li class="active"><a href="#tabs-1" data-toggle="tab">Pencairan Deposito</a></li>
                                   <li><a href="#tabs-2" data-toggle="tab">Search rekening</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tabs-1">
                                        <form class="form-horizontal" id="form_cairdeposito" method="post">
                                        <div class="span6 ">
                                        ...
                                        <div class="span6 ">
                                            ...
                                            <div class="control-group fm-req">
                                                ...
                                                <div class="controls">
                                                    <input name="jatuh_tempo" tabindex="0" readonly type="text" size="16" class="inp m-wrap m-ctrl-medium date-picker input-small">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="span11">
                                            <hr>
                                            <b>Nilai transaksi tarik investasi berjangka</b>
                                            <hr>
                                            <div class="control-group fm-req">
                                            ...
                                            <div class="control-group fm-req">
                                                <label class="control-label">Otorisasi <span class="required">*</span></label>
                                                <div class="controls">
                                                    <input name="otorisasi" tabindex="2" type="text" class="inp input-medium">
                                                </div>
                                            </div>
                                            <div class="control-group fm-req">
                                                <label class="control-label">Password <span class="required">*</span></label>
                                                <div class="controls">
                                                    <input name="password" tabindex="2" type="password" class="inp input-medium">
                                                </div>
                                            </div>
