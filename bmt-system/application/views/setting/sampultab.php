...
<head>
   ...
   <script src="../assets/scripts/form-validationtabungan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/setting/sampultab.js"></script>
</head>
                                    ...
                                    <div class="tab-pane active" id="tabs-1">
                                        <div class="widget box blue">
                                            <div class="widget-title">
                                               <h4><i class="icon-cogs"></i>Parameter cetak Sampul</h4>
                                            </div>
                                            <br>
                                            <div class="row-fluid">
                                                <form class="form-horizontal" id="form_setsampul" method="post">
                                                    <div class="control-group">
                                                        <label class="control-label">Batas Atas</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set1"> mm
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Batas Kiri</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set2"> mm
                                                        </div>
                                                    </div><!-- 
                                                    <div class="control-group">
                                                        <label class="control-label">Batas Kanan</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set3"> mm
                                                        </div>
                                                    </div> -->
