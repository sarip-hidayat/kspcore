...
<head>
   ...
   <script src="../assets/scripts/form-validationtabungan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/setting/logo.js"></script>
</head>
                        ...
                        <div class="span12">
                            <div class="tabbable tabbable-custom boxless">
                                <ul class="nav nav-tabs">
                                   <li class="active"><a href="#tabs-1" data-toggle="tab">Ganti Logo</a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tabs-1">
                                            ...
                                            <div class="form-actions">
                                                <button class="btn btn-primary cupload"><i class="icon-ok"></i> Upload Logo</button>
                                             </div>
                                            <p class="infonya"></p>
                                         </div>
                                    </div>
    ...
    <div id="dialog-upload">
	      <fieldset>
	        <div style="margin-left:100px;">
	            <form enctype="multipart/form-data" method="post" action="setting/logo/uploadfoto" id="formUpload" name="formUpload" target="upload_target">
