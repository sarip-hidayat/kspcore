...
<head>
   ...
   <script src="../assets/scripts/form-validationtabungan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/setting/theme.js"></script>
</head>
                                    ...
                                    <div class="tab-pane active" id="tabs-1">
                                        <div class="widget box blue">
                                            <div class="widget-title">
                                               <h4><i class="icon-cogs"></i>Parameter Tema Tampilan</h4>
                                            </div>
                                            <br>
                                            <div class="row-fluid">
                                                <form class="form-horizontal" id="form_setsampul" method="post">
                                                    <div class="control-group">
                                                        <label class="control-label">Tampilan CSS</label>
                                                        <div class="controls">
                                                            <select>
