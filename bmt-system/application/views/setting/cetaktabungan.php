...
<head>
	<meta charset="utf-8" />
	<title>KOPERASI ANNUR BERKAH MANDIRI</title>
   ...
   <script src="../assets/scripts/form-validationtabungan.js"></script> 
    ...
    <script type="text/javascript" src="assets/js/setting/cetaktabungan.js"></script>
</head>
                                    ...
                                    <div class="tab-pane active" id="tabs-1">
                                        <div class="widget box blue">
                                            <div class="widget-title">
                                               <h4><i class="icon-cogs"></i>Parameter cetak Tabungan</h4>
                                            </div>
                                            <br>
                                            <div class="row-fluid">
                                                <form class="form-horizontal" id="form_setbuku" method="post">
                                                    <div class="control-group">
                                                        <label class="control-label">Tanggal</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set4"> %
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Kode</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set5"> %
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Debet</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set6"> %
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Kredit</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set7"> %
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Saldo</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set8"> %
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Petugas</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set9"> %
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Batas atas</label>
                                                        <div class="controls">
                                                            <input type="text" class="input-small" name="set10"> cm
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">Jumlah baris</label>
                                                        <div class="controls">
