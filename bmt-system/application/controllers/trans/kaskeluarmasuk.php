 ...
 */
/*----------------------------------------------------------*/
class Kaskeluarmasuk extends Controller
{
    ...
    public function index()
    {
        ...
        $data['js_links'] = get_js(
            array(
            $assets_path .'/js/trans/kaskeluarmasuk.js',
        ...
        echo $this->twig_lib->render('tpl/trans/kaskeluarmasuk.php', $data);
    }
    
    public function tarikkas()
    {
