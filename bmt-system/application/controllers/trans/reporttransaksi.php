...
class Reporttransaksi extends Controller
{
    ...
    public function index()
    {
        ...
        $data['js_links'] = get_js(
            array(
            $assets_path .'/js/trans/reporttransaksi.js',
        ...
        echo $this->twig_lib->render('tpl/trans/reporttransaksi.php', $data);
    }
    ...
    public function viewtransaksi()
    {
        ...
        $query = $this->db->query(
            "SELECT TIME(create_date) AS waktu, accounttrans_date,accounttrans_code,accounttrans_type,accounttrans_desc,accounttrans_value,create_by,
