 ...
 * Copyright (c) 2014
 *
 * file   : trans/transaksilain.php
 * author : Edi Suwoto S.Komp
 * email  : edi.suwoto@gmail.com
 */
/*----------------------------------------------------------*/
class Transaksilain extends Controller
{
    ...
    public function index()
    {
        ...
        $data['js_links'] = get_js(
            array(
            $assets_path .'/js/trans/transaksilain.js',
        ...
        echo $this->twig_lib->render('tpl/trans/transaksilain.php', $data);
    }
    
    public function selisih()
    {
        $data = $this->allfunct->securePost();
        if ($data['accounttrans_code'] == "02") {
            ...
            $data2['accounttrans_listid'] = $data['accounttrans_type'];
