 ...
 */
/*----------------------------------------------------------*/
class Reportteller extends Controller
{
    ...
    public function index()
    {
        ...
        $data['tema'] = $this->tema;
        $data['page_title'] = "Transaksi Kasanah";
        ...
        $data['js_links'] = get_js(
            array(
            $assets_path .'/js/trans/reportteller.js',
        ...
        echo $this->twig_lib->render('tpl/trans/reportteller.php', $data);
    }
    
    public function saldokhasanah()
    {
    ...
    public function viewtransaksihead()
    {
        ...
        $hasil = $this->db->query(
            "SELECT accounttrans_date,accounttrans_code,accounttrans_type,accounttrans_desc,accounttrans_value,create_by,
                                    accounttrans_value
    ...
    public function viewtransaksi()
    {
        ...
        $query = $this->db->query(
            "SELECT accounttrans_user,TIME(create_date) AS waktu, accounttrans_date,accounttrans_code,accounttrans_type,accounttrans_desc,accounttrans_value,create_by,
    ...
    public function cetakLapTeller()
    {
