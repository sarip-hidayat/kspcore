...
class Pembiayaan extends Controller
{
    ...
    public function index()
    {
        ...
        $data['js_links'] = get_js(
            array(
            $assets_path .'/js/base/pembiayaan.js',
        ...
        echo $this->twig_lib->render('tpl/base/pembiayaan.php', $data);
    }
    ...
    // ---- Fungsi membantu Autocomplete
    public function search_jaminan()
    {
        $nama = strtoupper($this->input->post('q'));
    ...
    public function dataangsuran($id_pembiayaan)
    {
    ...
    public function get_jadwalview()
    {
    ...
    public function isi_pembiayaan()
    {
    ...
    public function filterpembiayaan()
    {
        $data = $this->allfunct->securePost();
        $jenis    = $data['jenis'];
    ...
    public function single_jaminan()
    {
        $data = $this->allfunct->securePost();
        $id    = $data['id'];
