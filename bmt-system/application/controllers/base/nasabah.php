...
class Nasabah extends Controller
{
    ...
    public function isi_kabupaten()
    {
        ...
        $hasil = $this->db->query(
            "SELECT kodeBPS,namaKabupaten, case when substring(kodeBPS, 3, 1) = '7' then concat('KOTA ', namaKabupaten) else namaKabupaten end AS titlename 

                                    FROM kabupaten

                                    WHERE kodeProvinsi='".$prov."' order by namaKabupaten"
        )->result();
    ...
    public function isi_kecamatan()
    {
        ...
        $hasil = $this->db->query(
            "SELECT kodeBps,namaKecamatan

                                    FROM kecamatan

                                    WHERE kodeKabupaten='".$kab."' order by namaKecamatan"
        )->result();
