...
class Neraca extends Controller
{
    ...
    public function index()
    {
        ...
        $data['js_links'] = get_js(
            array(
            $assets_path .'/js/akunting/neraca.js',
        ...
        echo $this->twig_lib->render('tpl/akunting/neraca.php', $data);
        // $this->load->view('akunting/neraca',$data);
    }
    
    public function sum_neraca()
    {
    ...
    public function nilaivalue($id, $tglawal)
    {
    ...
    public function Labarugi($tglakhir)
    {
        $id = "5,6,7";
        $hasil = $this->db->query("SELECT listakun_id,listakun_code,listakun_name FROM coa_listakun WHERE listakun_parent = '0' AND listakun_pattern IN(".$id.")")->result();
        $totalLabaAll = 0;
    ...
    public function nilaivalueLaba($id, $tglakhir)
    {
