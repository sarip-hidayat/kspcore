...
class Posting extends Controller
{
    ...
    public function index()
    {
        ...
        $data['js_links'] = get_js(
            array(
            $assets_path .'/js/akunting/posting.js',
        ...
        echo $this->twig_lib->render('tpl/akunting/posting.php', $data);
        // $this->load->view('akunting/posting',$data);
    }
    
    public function get_koreksiview()
    {
        ...
        $query = $this->db->query("SELECT * FROM tb_accounttrans ".$where."");
        $data = $query->result_array();
        //echo $data;
        $hasil['alldata'] = $data;
        echo json_encode($hasil);
    }
    public function delkoreksi()
    {
    ...
    public function get_transaksiview()
    {
        $tgl1 = $this->allfunct->revDate($this->input->post('tgl1'));
        $tgl2 = $this->allfunct->revDate($this->input->post('tgl2'));
