 ...
 */
/*----------------------------------------------------------*/
class Setupmenu extends Controller
{
    ...
    */
    ...
    public function getMenuapp()
    {
        ...
        $hasil = $this->db->query(
            "SELECT `menu_id`,`nama`,`href`,`icon`,`css`,`sub`,`urutan`,`parent`,`groups`
                                    FROM `menuapp`
            ...
            if ($row->menu_id == "1") {
                ...
                $items .= "<li class=\"has-sub ".$status."\">
                        ...
                        $submenu = $this->db->query(
                            "SELECT `menu_id`,`nama`,`href`,`icon`,`css`,`parent`,`groups`
                                                    FROM `menuapp`
                        ...
                        foreach ($submenu as $rowm) {
                            if ($menuactsub == $rowm->css) {
                                $statusc ='class="active"';
                            } else {
                                $statusc ='';
                            }
