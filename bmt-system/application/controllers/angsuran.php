...
class Angsuran extends Controller
{
    ...
    public function index()
    {
        ...
        $data['js_links'] = get_js(
            array(
            $assets_path .'/js/fungsi.js',
            $assets_path .'/js/angsuran.js',
        ...
        echo $this->twig_lib->render('tpl/angsuran.php', $data);

        // $this->load->view('angsuran',$data);
    }

    public function _loadMenu($parent)
    {
