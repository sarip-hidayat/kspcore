        ...
        $.post("monitor/npf/get_dataview","tgl1="+ tgl1 +"&tgl2="+ tgl2 +"&fv="+ fv +"&ifv="+ ifv,
             function(json){
                 ...
                 for(i = 0; i < json['alldata'].length; i++) {
                     ...
                     data = json['alldata'][i];
                	 var angsuran = ajak("monitor/npf/get_dataangsuran","id="+ data.pembiayaan_id);
                	 var res = angsuran.split("#"); 
                	 totalangs = eval(res[0]) + eval(res[1]);
                	 //total angsuran
                	 var resp = ajak("monitor/npf/get_totalangsuran","id="+ data.nomor_rekening + "&tgl2="+ tgl2);
                	 ...
                	 // D  : Diragukan = 3
                	 // M  : Macet >= 4
                	 var coltrans = ajak("monitor/npf/get_coltrans","id="+ data.nomor_rekening +"&tgl1="+ tgl1 +"&tgl2="+ tgl2);
                	 var coljadwal = ajak("monitor/npf/get_coljadwal","id="+ data.pembiayaan_id +"&tgl1="+ tgl1 +"&tgl2="+ tgl2);
                	...
                	}else if(data.type_angsuran == "BULAN") {	
                	...
                	}else if(data.type_angsuran == "MINGGU") {	
                	 ...
                	 isi += "<tr>"
                		 + "<td style=\"border-top:1px solid #000;border-right:1px solid #000\" align=\"center\">"+ data.nomor_rekening +"</td>" 
                		 + "<td style=\"border-top:1px solid #000;border-right:1px solid #000\" align=\"left\">"+ data.nama +"</td>" 
                		 + "<td style=\"border-top:1px solid #000;border-right:1px solid #000\" align=\"center\">"+ data.nama_pegawai +"</td>" 
                		 + "<td style=\"border-top:1px solid #000;border-right:1px solid #000\" align=\"center\">"+ revDate(data.tgl_dibuka,'-') +"</td>" 
                		 + "<td style=\"border-top:1px solid #000;border-right:1px solid #000\" align=\"center\">"+ revDate(data.jatuh_tempo,'-') +"</td>" 
                		 ...
                		 + "<td style=\"border-top:1px solid #000;border-right:1px solid #000\" align=\"center\">"+ data.type_angsuran +"</td>" 
