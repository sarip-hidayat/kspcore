    ...
    $('#buatdaftar').click(function() {
        ...
        $.post("monitor/cetaktabungan/get_cetaktrans","tglawal=" + $('#tgllap1').val() + "&tglakhir=" + $('#tgllap2').val() + "&id=" + norekening,
            ...
            function(obj){
                ...
                saldoawal = saldon * 1;
                isi += "<tr>"
                    + "<td align=\"left\" style=\"width: 5%\">" + No + "</td>"
                    + "<td align=\"center\">" + $('#tgllap1').val() + "</td>"
                    + "<td align=\"center\" style=\"width:15%\"> - </td>"
                    + "<td align=\"right\" style=\"margin-right:2px;width:15%\"> - </td>"
                    + "<td align=\"right\" style=\"margin-right:2px;width:15%\"> - </td>"
                    + "<td align=\"right\" style=\"margin-right:2px;width:15%\">" + format_uang(saldoawal)+ "</td>"
                    + "<td align=\"right\"> - </td>"
                    + "</tr>";
                saldotot = saldoawal;
                ...
                for(i = 0; i < barisN; i++) {
                    ...
                    isi += "<tr>"
                        ...
                        + "<td align=\"center\" style=\"width:15%\">" + obj['alldata'][i].accounttrans_type + "</td>"
                        + "<td align=\"right\" style=\"margin-right:2px;width:15%\">" + format_uang(debet) + "</td>"
                        + "<td align=\"right\" style=\"margin-right:2px;width:15%\">" + format_uang(kredit) + "</td>"
                        + "<td align=\"right\" style=\"margin-right:2px;width:15%\">" + format_uang(saldotot)+ "</td>"
