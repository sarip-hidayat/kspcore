...
$(document).ready(function(){
    ...
    $('#dialog-kharian').dialog({autoOpen: false,width: 400,modal: true,
     ...
     $('#addmingguan').click(function() {

        $(".infonya").hide();

        $('.inp').val('');

        $('#dialog-kmingguan').dialog('option', 'title',  'Tambah Kolekbilitas Mingguan' ).dialog('open');

        return false;

     });

     $('#addbulanan').click(function() {

        $(".infonya").hide();

        $('.inp').val('');

        $('#dialog-kbulanan').dialog('option', 'title',  'Tambah Kolekbilitas Bulanan' ).dialog('open');
