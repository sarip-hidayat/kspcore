 ...
 */
        ...
        if (hasil['isi'] != "invalid") {
            ...
            if(limit == "no"){
                ...
                if (respon[0] == "1") {
                	...
                	// $('#nomortransaksi',ctkframe.document).html(respon[1])+':8069/web/');
                    ...
                    setTimeout(function(){window.location.href = "/bmt/setortunai"}, 1000);
                } else {
    ...
    function(hal,juml,json) {
        ...
        for(i = 0; i < json['alldata'].length; i++) {
            ...
            jns_tab = ajak('base/tabungan/single_jnstab','&jnstab='+json['alldata'][i].jenis_simpanan);
            //
